...
//echo "INSERT INTO `Universities`(`Name`, `Short_Name`, `Vertical`, `Address`, `Logo`, `Is_B2C`,`Is_Vocational`,Has_LMS) VALUES ('$name', '$short_name', '$vertical', '$address', '$filename', '$university_type',1,1)";die;
    $add = $conn->query("INSERT INTO `Universities`(`Name`, `Short_Name`, `Vertical`, `Address`, `Logo`, `Is_B2C`,`Is_Vocational`,Has_LMS) VALUES ('$name', '$short_name', '$vertical', '$address', '$filename', '$university_type',1,1)");
    if($add){
