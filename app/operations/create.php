...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
  ...
  <h5 class="fs-4 text-black fw-bold">Add <span class="semi-bold"></span>Operation's User</h5>
</div>
<!-- <form role="form" id="form-add-operations" action="/app/operations/store" method="POST" enctype="multipart/form-data">
...
<form class="card-body" role="form" id="form-add-operations" action="/app/operations/store" method="POST" enctype="multipart/form-data">
