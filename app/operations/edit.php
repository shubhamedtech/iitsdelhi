<?php 
  if(isset($_GET['id'])){
    ...
    $id = intval($_GET['id']);
    $user = $conn->query("SELECT Name, Code, Email,Photo, Mobile FROM Users WHERE ID = $id");
...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
  ...
  <h5 class="fs-4 text-black fw-bold">Edit <span class="semi-bold">Operation's User</span></h5>
</div>
<!-- <form role="form" id="form-edit-operations" action="/app/operations/update" method="POST" enctype="multipart/form-data">
...
<form class="card-body" role="form" id="form-edit-operations" action="/app/operations/update" method="POST" enctype="multipart/form-data">
