<?php if (isset($_GET['university_id'])) { ?>
  ...
  <div class="modal-header clearfix text-left m-0 p-0">
    ...
    <h6 class="fs-4 text-black fw-bold">Add <span class="semi-bold">Admission Type</span></h6>
  </div>
  ...
  <form class="card-body" role="form" id="form-add-admission-types" action="/app/components/admission-types/store" method="POST">
    <div class="row mb-4">
      <div class="col-sm-12">
        <label class="col-form-label" for="multicol-full-name">Name <span class="text-danger">*</span></label>
        <input type="text" id="name" name="name" class="form-control" placeholder="ex: Regular" required>
      </div>
    </div>
    <div >
