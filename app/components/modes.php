<div id="accordionDelivery" class="accordion mt-2">
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" aria-expanded="true" data-bs-target="#modes" aria-controls="modes"> Modes</button>
    </h2>
    <div id="modes" class="accordion-collapse collapse ">
      <div class="accordion-body">
        <div class="card-body">
          <div class="row p-b-20 mb-3">
            <div class="col-lg-12 text-end">
              <button type="button" class="btn btn-primary" onclick="addComponents('modes', 'md', '<?= $university_id ?>')"><i class="ri-apps-2-add-line"></i></button>
            </div>
          </div>
          <div class="card">
            <div class="card-datatable table-responsive">
              <div id="DataTables_Table_3_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <div class="table-responsive">
                  <table class="dt-multilingual table table-bordered dataTable no-footer dtr-column ctable" id="tableModeDatatable" aria-describedby="DataTables_Table_3_info">
                    <thead>
                      <tr>
  ...
  var settings = {
    ...
    columns: [
      ...
      { 
        ...
        render: function(data, type, row) {
          ...
          return '<div class="form-check form-switch mb-2 d-flex flex-row justify-content-center">\
            <input class="form-check-input me-3" onclick="changeComponentStatus(\'Modes\', \'Modes\', \'' + row.ID + '\');" type="checkbox" ' + checked + ' id="mode-status-switch-' + row.ID + '">\
      ...
      },
      {
        ...
        render: function(data, type, row) {
          return '<div class="">\
            <i class="ri-edit-box-fill text-success" onclick="editComponents(\'modes\', \'' + data + '\', \'md\');"></i>\
            <i class="ms-3 ri-delete-bin-5-line text-danger" onclick="destroyComponents(\'modes\', \'ModeDatatable\', \'' + data + '\');"></i>\
          </div>';
        }
      }
    ],
