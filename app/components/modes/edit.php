...
?>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    <h6 class="fs-4 text-black fw-bold">Edit <span class="semi-bold">Mode</span></h6>
  </div>
  ...
  <form class="card-body" role="form" id="form-edit-modes" action="/app/components/modes/update" method="POST">
    <div class="row mb-4">
      <div class="col-sm-12">
        <label class="col-form-label" for="multicol-full-name">Name <span class="text-danger">*</span></label>
        <input type="text" id="name" name="name" class="form-control" value="<?php echo $mode['Name'] ?>" placeholder="ex: Sem" required>
      </div>
    </div>
    <div >
