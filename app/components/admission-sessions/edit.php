...
?>
    ...
    <div class="modal-header clearfix text-left m-0 p-0">
      ...
      <h6 class="fs-4 text-black fw-bold">Edit <span class="semi-bold">Admission Sessions</span></h6>
    </div>
    ...
    <form class="card-body" role="form" id="form-edit-admission-sessions" action="/app/components/admission-sessions/update" method="POST">
      <div class="row mb-4">
        <div class="col-sm-6 mb-3">
          <label class="col-form-label m-0 p-0" for="multicol-full-name">Name <span class="text-danger">*</span></label>
          <input type="text" id="name" name="name" class="form-control" value="<?php echo $admission_session['Name'] ?>" placeholder="ex: Jan-22" required>
        </div>
        <div class="col-sm-6 mb-3 ">
          <label class="col-form-label m-0 p-0" for="multicol-full-name">Exam Session <span class="text-danger">*</span></label>
          <input type="text" id="exam_session" name="exam_session" class="form-control" value="<?php echo $admission_session['Exam_Session'] ?>" placeholder="ex: July-22" required>
        </div>
