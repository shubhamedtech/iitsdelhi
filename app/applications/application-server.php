...
if ($searchValue != '') {
  if (!empty(strpos($searchValue, "="))) {
   ...
   // $searchQuery = " AND (RIGHT(CONCAT('000000', Students.ID), 6) like '%" . $searchValue . "%' OR Students.ID like '%" . $searchValue . "%' OR Students.Unique_ID like '%" . $searchValue . "%' OR Students.First_Name like '%" . $searchValue . "%' OR Students.Middle_Name like '%" . $searchValue . "%' OR Students.Last_Name like '%" . $searchValue . "%' OR Admission_Sessions.Name like '%" . $searchValue . "%' OR Admission_Types.Name like '%" . $searchValue . "%' OR Students.Step like '%" . $searchValue . "%' OR Students.Father_Name like '%" . $searchValue . "%' OR Students.Email like '%" . $searchValue . "%' OR Students.Contact like '%" . $searchValue . "%' OR Sub_Courses.Short_Name like '%" . $searchValue . "%' OR Students.Enrollment_No like '%" . $searchValue . "%' OR Students.OA_Number like '%" . $searchValue . "%')";
     $searchQuery = " AND (RIGHT(CONCAT('000000', Students.ID), 6) like '%" . $searchValue . "%' OR CONCAT(Students.First_Name, ' ', Students.Middle_Name, ' ', Students.Last_Name) = '$searchValue' OR CONCAT(Students.First_Name, ' ', Students.Middle_Name) = '$searchValue'  OR Students.ID like '%" . $searchValue . "%' OR Students.Unique_ID like '%" . $searchValue . "%' OR Students.First_Name like '%" . $searchValue . "%' OR Students.Middle_Name like '%" . $searchValue . "%' OR Students.Last_Name like '%" . $searchValue . "%' OR Admission_Sessions.Name like '%" . $searchValue . "%' OR Admission_Types.Name like '%" . $searchValue . "%' OR Students.Step like '%" . $searchValue . "%' OR Students.Father_Name like '%" . $searchValue . "%' OR Students.Email like '%" . $searchValue . "%' OR Students.Contact like '%" . $searchValue . "%' OR Sub_Courses.Short_Name like '%" . $searchValue . "%' OR Students.Enrollment_No like '%" . $searchValue . "%' OR Students.OA_Number like '%" . $searchValue . "%')";
