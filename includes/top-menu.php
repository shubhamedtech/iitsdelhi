  ...
  <ul class="navbar-nav flex-row align-items-center ms-auto">
    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
      <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
        ...
        if (!empty($dark_logo)) { ?>
          <img src="<?= $dark_logo ?>" class="rounded-circle" alt="logo" data-src="<?= $dark_logo ?>" data-src-retina="<?= $dark_logo_retina ?>" height="35" style="max-width:120px">
        <?php }
        ...
        ?>
          <img src="<?= $logo['Photo'] ?>" class="rounded-circle" alt="center_logo" data-src="<?= $logo['Photo'] ?>" data-src-retina="<?= $logo['Photo'] ?>" height="35">
      <?php }
      } ?> -->
        </div>
      </a>
      <ul class="dropdown-menu dropdown-menu-end">
        <li>
          <a class="dropdown-item" href="pages-account-settings-account.html">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1">
                <span class="fw-medium d-block small fs-6 fw-bold"><?= ucwords(strtolower($_SESSION['Name'])) ?></span>
        ...
        <li>
          <a class="dropdown-item" href="pages-faq.html" onclick="changePassword(<?= $_SESSION['ID'] ?>)">
            <i class="ri-question-line ri-22px me-3"></i><span class="align-middle">Change Password</span>
          </a>
        </li>
