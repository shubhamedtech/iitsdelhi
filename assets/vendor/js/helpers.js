                  ...
                  var n,
                    ...
                    c =
                      ...
                      (n /= t / 2) < 1
                        ...
                        : (-l / 2) * ((n -= 1) * (n - 2) - 1) + i);
                  (o.scrollTop = c),
                    u < t ? requestAnimationFrame(e) : (o.scrollTop = a);
                })()
              : (o.scrollTop = a);
          }
        }
            ...
            e.addEventListener("click", function (t) {
              ...
              "text" === o.getAttribute("type")
                ? (o.setAttribute("type", "password"),
                  i.classList.replace("ri-eye-line", "ri-eye-off-line"))
                : "password" === o.getAttribute("type") &&
                  (o.setAttribute("type", "text"),
                  i.classList.replace("ri-eye-off-line", "ri-eye-line"));
            });
          });
      },
      ...
      navTabsAnimation: function () {
        setTimeout(function () {
          document.querySelectorAll(".nav-tabs").forEach(function (e) {
            ...
            var i =
                e.closest(".nav-align-left") || e.closest(".nav-align-right"),
              o = function (n) {
                ...
                i
                  ? ((t.style.top = r.y - o.y + "px"),
                    (t.style[
                      e.closest(".nav-align-right")
                        ? "inset-inline-start"
                        : "inset-inline-end"
                    ] = 0),
            ...
            e.addEventListener("click", function (e) {
              e.target.closest(".nav-item .active") &&
                o(e.target.closest(".nav-item"));
            }),
