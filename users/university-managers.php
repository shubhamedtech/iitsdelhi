...
<div class="layout-page">
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
                ...
                ?>
                <div class="text-end">
                    <!-- <span class="text-muted bold cursor-pointer" onclick="add('university-heads','lg')"> Add</sapn> -->
                    <span type="button" class="btn btn-primary" onclick="add('university-heads','md')"> <i class="ri-apps-2-add-line"></i> </span>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var settings = {
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': '/app/university-heads/server'
                },
                'columns': [{
                        data: "Photo",
                ...
                <i class="ri-apps-2-add-line" data-toggle="tooltip" data-placement="top" title="Allot University" onclick="allot(&#39;' + data + '&#39, &#39;sm&#39;)"></i>\
                <i class="ri-edit-box-fill text-success  ms-3" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;university-heads&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                <i class="ms-3 ri-delete-bin-5-line text-danger" data-toggle="tooltip" data-placement="top" title="Delete" onclick="destroy(&#39;university-heads&#39;, &#39;' + data + '&#39)"></i>\
              </div>'
                        }
                    },
                ],
    ...
    <script>
        function allot(id, modal) {
            $.ajax({
                url: '/app/university-heads/allot-universities?id=' + id,
                type: 'GET',
